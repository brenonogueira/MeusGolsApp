            ...
            return Dismissible(
                  ...
                  builder: (context) {
                    return Dialog(
                      child: ElevatedButton(
                        ...
                        child: const Text("Deseja mesmo deletar esta partida?"),
                      ),
                    );
                  },
                );
              ...
              child: Card(
                child: ListTile(
                  ...
                  subtitle: Text(
                    DatesUtils.formatDate(widget.matchesList[index].match_date),
                  ),
                  trailing: Text(
